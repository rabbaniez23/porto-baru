...
export const Preloader = ({ onEnter }) => {
  ...
  return (
    <div ref={containerRef} className="preload select-none">
      <div className="gears">
        <img className="gear-big gear1" src="https://paralleluniverse.com.ua/wp-content/themes/e-parallel-smooth/images/gear1.png" alt="gear-big" />
        <img className="gear-2" src="https://paralleluniverse.com.ua/wp-content/themes/e-parallel-smooth/images/gear2.png" alt="gear-2" style={{ position: 'absolute', top: '25%', left: '25%', transform: 'scale(0.7)' }} />
        <img className="gear-4" src="https://paralleluniverse.com.ua/wp-content/themes/e-parallel-smooth/images/gear2.png" alt="gear-4" style={{ position: 'absolute', top: '45%', left: '15%', transform: 'scale(0.7)' }} />
        <img className="gear-3" src="https://paralleluniverse.com.ua/wp-content/themes/e-parallel-smooth/images/gear3.png" alt="gear-3" />
        <img className="gear-5" src="https://paralleluniverse.com.ua/wp-content/themes/e-parallel-smooth/images/gear3.png" alt="gear-5" />
      </div>
